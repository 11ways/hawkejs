 ...
 * @param    {String}   source
 */
var Htmltok = Fn.inherits('Hawkejs.Parser', function HtmlTokenizer(source) {
 ...
 * @version  1.3.2
 */
Htmltok.setMethod(function parseCode(close_str, type) {
 ...
 * @return   {String}
 */
Htmltok.setMethod(function convert() {

	var result = '';

	console.log('Converting tokens', this.result);

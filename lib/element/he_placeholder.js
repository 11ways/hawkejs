...
Placeholder.setMethod(function getContent(callback) {
	return Hawkejs.callDeprecatedRenderContent(this).done(callback);
});
 ...
 */
Hawkejs.setCachedMethod(Placeholder, Hawkejs.RENDER_CONTENT, function renderHawkejsContent(renderer) {
	...
	console.log('Rendering placheolder...', this)

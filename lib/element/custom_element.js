...
/**
 * Set the template file to use for the content
 *
 * @author   Jelle De Loecker <jelle@develry.be>
 * @since    2.0.0
 * @version  2.0.0
 ...
 * @param    {String}
 */
Element.setStatic(function addObservedAttribute(name) {

	if (!this._observed_attributes) {
		this._observed_attributes = [];

		this.setStaticProperty(function observedAttributes() {
			return this._observed_attributes.slice(0);
		});
	}

	this._observed_attributes.push(name);
});

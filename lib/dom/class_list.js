 ...
 * @version  1.1.0
 */
var ClassList = Fn.inherits(null, 'Hawkejs', function ClassList(element) {
 ...
 * @version  2.2.16
 */
ClassList.setMethod(function add(...classnames) {
 ...
 * @version  2.2.16
 */
ClassList.setMethod(function remove(...classnames) {

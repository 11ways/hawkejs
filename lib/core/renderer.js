...
Renderer.setMethod(function createPreloadHtml() {
	...
	html += '\t\t<link rel="preload" href="' + hawkejs.createScriptUrl(hawkejs.client_path, {root_path: ''}) + '" as="script">\n';
...
function _getFoundationContent(pledge, renderer, hawkejs, options) {
	...
	hs_path = hawkejs.createScriptUrl(hawkejs.client_path, {root_path: ''});

module.exports = function hawkejsRegisterElement(HawkejsNS, Blast) {
	 ...
	 * @version  1.3.0
	 */
	Function.inherits('Hawkejs.Element', function HeBound() {
		HeBound.super.call(this);
	});
	...
	Hawkejs.onAttribute('data-update-request', function gotElement(element, value, old_value, created) {
		...
		element.addEventListener(event_type, function onEvent(e) {

...
Scene.setMethod(function openUrl(href, options, callback) {
	...
	function isStillSameRequest(check_against_pledge) {

		if (check_against_pledge == null) {
			check_against_pledge = pledge;
		}

		if (that.opening_url == check_against_pledge) {
			return true;
		}

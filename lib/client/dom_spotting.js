		...
		if (mutation.type == 'attributes') {
			if (attributes[mutation.attributeName]) {
				for (l = 0; l < attributes[mutation.attributeName].length; l++) {
					attributes[mutation.attributeName][l](mutation.target, mutation.target.attributes[mutation.attributeName].value, mutation.oldValue, false);
				}
			}
		}
	}

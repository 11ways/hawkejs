module.exports = function hawkHTMLStyle(Hawkejs, Blast) {
	 ...
	 * @version  1.0.0
	 */
	var Attribute = Function.inherits(null, 'Hawkejs', function Attribute(name, value) {
		if (name) {
			this.name = name;
	 ...
	 * @version  1.0.0
	 */
	var Style = Function.inherits(null, 'Hawkejs', function Style(element) {

module.exports = function(Hawkejs, Blast) {
	 ...
	 * @version  1.0.0
	 */
	ViewRender = Blast.Classes.Informer.extend(function ViewRender(parent) {

		// Call Informer constructor
		ViewRender.super.call(this);
	 ...
	 */
	ViewRender.setMethod(function beginRender(templateName, variables, callback) {
		...
		this.execute(templateName, this.variables, true, function afterExec() {
	 ...
	 * @param    {Function} callback    Optional callback to run after execution
	 */
	ViewRender.setMethod(function execute(name, variables, changeMain, callback) {
	 ...
	 */
	ViewRender.setMethod(function implement(elementName, variables) {
